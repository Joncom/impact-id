...
/*
=================
idFile_BitMsg::ReadNumber
=================
*/
idFile_BitMsg.prototype.ReadNumber = function() {
...
/*
=================
idFile_BitMsg::WriteNumber
=================
*/
idFile_BitMsg.prototype.WriteNumber = function( n ) {
    var buffer = new ArrayBuffer(Float64Array.BYTES_PER_ELEMENT);
    var floatView = new Float64Array(buffer, 0, 1);
    var intView = new Uint8Array(buffer, 0, 8);
    floatView[0] = n;
